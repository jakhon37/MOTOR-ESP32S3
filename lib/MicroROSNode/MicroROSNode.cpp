...
#else
  #error "Please define either USE_WIFI or USE_USB in your build flags."
#endif
...
void MicroROSNode::begin() {
  // Select the correct micro-ROS transport based on build flag
  #if defined(USE_WIFI)
    set_microros_wifi_transports(WIFI_SSID, WIFI_PASSWORD, AGENT_IP, AGENT_PORT);
    Serial.println("Using WiFi transport for micro-ROS.");
  #elif defined(USE_USB)
